  ...
  function resetGame() {
    ...
    if (hardMode) {
      noteElement.innerHTML = `Boshlash uchun joystikni bosing
          <p>Qattiq rejim, qora tuynuklardan qoching. Oson rejimga qaytasizmi? E tugmasini bosing</p>`;
    } else {
      noteElement.innerHTML = `Boshlash uchun joystikni bosing
          <p>Har bir to'pni markazga olib boring. Qattiq rejimga tayyormisiz? H tugmasini bosing</p>`;
    }
  ...
  function main(timestamp) {
    ...
    try {
      ...
      if (
        ...
        noteElement.innerHTML = `Tabriklaymiz, siz buni qildingiz!
          ${!hardMode ? "<p>Qattiq rejim uchun H tugmasini bosing</p>" : ""}
          <p>
          Menga obuna bo'lishni unutmang!
            <a href="https://t.me/javohir_my_blog" , target="_top"
              >@B_Javohir</a
            >
          </p>`;
        noteElement.style.opacity = 1;
